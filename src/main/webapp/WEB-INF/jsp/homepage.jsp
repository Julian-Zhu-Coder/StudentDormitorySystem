...
<%--    获取到web目录路径--%>
    ...
    <script src="${APP_PATH }/layui_exts/excel.js"></script>

    <style>
        .o_div{
            background: url("${APP_PATH }/images/01.jpg") no-repeat;
        }
        .o_span{
            display: block;
            text-align: center;
...
<div class="container">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;"><img src="http://img.qqzhi.com/uploads/2019-04-15/212720872.jpg" class="layui-nav-img">${sessionScope.ad.a_username}</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
