...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.julian.domain.StudentClean" isELIgnored="false"%>
...
<head>
    ...
    <link rel="stylesheet" href="${APP_PATH }/css/pg_btn.css">
